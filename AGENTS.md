...
- Ultra readiness (on NAS): `RA2_COMPOSE_ULTRA=1 sh scripts/check-ultra-ready.sh`
- Production redeploy (red-zone): `NAS_HOST=MediaServer2 sh scripts/redeploy-ultra.sh`
